from utils.mpl_import import patches, plt
...
def plot_mlp():
    ...
    plt.scatter(twos[0:3], y_2[1:], s=500, c='white',
    ...
    names_2 = [r'$\hat{\mu}_{yP}$', r'$\hat{\mu}_{xP}$',
               r'$\hat{\mu}_{y1}$', r'$\hat{\mu}_{x1}$']
    ...
    plt.annotate(r'$\tilde{v}_*$', (2.5, 0), ha='center', va='center')
